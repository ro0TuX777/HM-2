document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateConfigPanel(device) {
        ...
        document.getElementById('disk-usage').value = device.metrics.disk_usage || 0;
        document.getElementById('vulnerability-score').value = device.metrics.vulnerability_score || 0;
    ...
    // Add the missing removeConnection function and expose it to the global scope
